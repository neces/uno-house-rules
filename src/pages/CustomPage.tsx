        ...
        <header className="mb-8 sm:mb-10">
          ...
          <div className="no-print mt-5 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="min-h-[40px] px-3 py-2 rounded-md border-2 border-uno-yellow-deep text-uno-yellow-deep bg-paper/70 font-marker tracking-wide hover:bg-uno-yellow hover:text-uno-black transition-colors"
            >
              Reset to Neja's
            </button>
          </div>
